...
<% if(esAdmin) { %>
		...
		onclick="confirmarEliminar('${pageContext.request.contextPath}/docentes/eliminar/${d.idDocente}','${d.nombre} ${d.apellido}')">
		Eliminar
		</button>
...
<script src="${pageContext.request.contextPath}/resource/js/Docentes.js"></script>
</body>
</html>
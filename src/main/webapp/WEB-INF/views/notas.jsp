...
<% if(puedeGestionarNotas) { %>
    ...
    <button class="btn btn-danger btn-sm"
        onclick="confirmarEliminar('${pageContext.request.contextPath}/notas/eliminar/${n.idNota}','Nota #${n.idNota}')">
        Eliminar
    </button>
	</td>
<% } %>
...
<c:if test="${empty listaNotas}">
    <tr>
       <td colspan="<%= puedeGestionarNotas ? 9 : 8 %>"class="text-center text-muted py-3">No hay calificaciones registradas en este periodo académico.</td>
	</tr>
</c:if>
</tbody>
</table>
...
<script src="${pageContext.request.contextPath}/resource/js/Notas.js"></script>
</body>
</html>
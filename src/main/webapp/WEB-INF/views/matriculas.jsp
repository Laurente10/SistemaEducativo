...
<% if(puedeMatricular) { %>
    <button
        ...
        onclick="confirmarEliminar('${pageContext.request.contextPath}/matriculas/eliminar/${m.idMatricula}','Matrícula N° ${m.idMatricula}')">
        Retirar
    </button>
...
<script src="${pageContext.request.contextPath}/resource/js/Matriculas.js"></script>
</body>
</html>
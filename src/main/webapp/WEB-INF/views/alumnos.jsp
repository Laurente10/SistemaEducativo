...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <% if(esAdmin) { %>
         ...
         <form action="${pageContext.request.contextPath}/alumnos/guardar" method="POST" onsubmit="return confirmarGuardar(this);">
...
<script src="${pageContext.request.contextPath}/resource/js/Alumnos.js"></script>
</body>
</html>
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/usuarios.css">
</head>
<body>
<div class="container mt-4">
    ...
    <div class="card card-custom p-4 mb-4">
        ...
        <option value="${r.idRole}">${r.nombre}</option>
        </c:forEach>
        </select>
        <div class="mb-3" id="divAlumno" style="display:none;">
    	<label class="form-label">Alumno asociado</label>
        ...
        <option value="${a.idAlumno}">${a.nombre} ${a.apellido}</option>
         ...
         <a href="${pageContext.request.contextPath}/dashboard" class="btn btn-secondary">Volver</a>
</form>
</div>
...
<td>
        ...
        <button class="btn btn-danger btn-sm" onclick="confirmarEliminacion(
        	'${pageContext.request.contextPath}/usuarios/eliminar/${u.idUsuario}',
            '${u.username}')">Eliminar</button>
   		</c:if>
    	<c:if test="${u.idUsuario == 1}">
...
<script src="${pageContext.request.contextPath}/resource/js/Usuarios.js"></script>
</body>
</html>
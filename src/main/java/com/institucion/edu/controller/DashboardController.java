...
public class DashboardController {
    ...
    public String dashboardAdmin( HttpSession session, Model model) {
        ...
        model.addAttribute("aprobados", notaRepository.contarAprobados());

        model.addAttribute("desaprobados", notaRepository.contarDesaprobados());
        
        model.addAttribute("ultimasMatriculas", matriculaRepository.findTop5ByOrderByIdMatriculaDesc());

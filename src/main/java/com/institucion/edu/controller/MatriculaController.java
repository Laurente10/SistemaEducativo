...
public class MatriculaController {
    ...
    @PostMapping("/guardar")
    public String guardarMatricula( @ModelAttribute("matricula") Matricula matricula, HttpSession session) {
    ...
    public String debaBajaMatricula( @PathVariable("id") int id, HttpSession session) {
